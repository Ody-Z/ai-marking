...
@patch('backend.services.pdf_processor.MarkItDown')  # Class-level patch
class TestPDFProcessor(unittest.TestCase):
    ...
    def test_init(self, mock_markitdown):
        ...
        # Check if MarkItDown was initialized
    ...
    def test_pdf_to_markdown_success(self, mock_markitdown):
        ...
        mock_instance.convert.assert_called_once_with(self.test_pdf_path)

    def test_pdf_to_markdown_file_not_found(self, mock_markitdown):
    ...
    def test_pdf_to_markdown_conversion_error(self, mock_markitdown):
